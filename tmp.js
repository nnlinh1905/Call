...
var user = {
  Display: 888,
  User: 888,
  WSServer: "wss://vcwebrtc.voicecloud.vn:9443",
  Pass: "Y4WE37eqZ",
  Realm: "alphagroupdemo.vn",
};
...
$(document).ready(function () {
  ...
  ctxSip = {
    ...
    sipHangUp: function (sessionid) {
      ...
      //console.log(
        "abcdzxdfghjkldfghjkl;dfghjkldfghjkldfghjkdfghjkfdhjgsajfdshgfjskdhfsldjfsdfbskdjfhsdhfgsdfhsdggfshjkdfhgsdkfhsgdsjgfsjdghsjkfgshdfjkshg"
      );
      var s = ctxSip.Sessions[sessionid];
      if (!s) {
        return;
