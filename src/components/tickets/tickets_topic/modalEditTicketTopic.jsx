...
const modalEditTicketTopic = (props) => {
  ...
  const handleUpdate = async () => {
    if (!request.name) {
      ...
      dispatch(editTopicTickectAPI(request));
      setTimeout(() => {
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-4 border-b border-solid border-slate-200 rounded-t  bg-gradient-to-r from-[#2d50b2] to-[#91a3eb]">
                  <div className=" text-base w-full text-white">Sửa chủ đề</div>
                </div>
                {/*body*/}
...
export default modalEditTicketTopic;
