...
import ModalAdd from "./modalAddTicketStatus";
import { useDispatch, useSelector } from "react-redux";
import {
  listStatusTickectAPI,
  dataStatusTicket,
  deleteStatusTickectAPI,
} from "../../../features/ticketStatusSlice";
import ModalEditTicketStatus from "./modalEditTicketStatus";
...
const listTicketStatus = () => {
  ...
  const tmp = useSelector(dataStatusTicket);
          ...
          return (
            <td className="flex ml-5">
              <div
                ...
                style={{ backgroundColor: tableMeta.rowData[2] }}
              ></div>
            </td>
          );
        },
  ...
  const handleConfixData = async () => {
    ...
    arrTmp &&
      ...
      arrTmp.map((element) => {
        ...
        obj.active_check = element.active;
        obj.active =
          element.active == 1
  ...
  const handleDelete = (id) => {
    dispatch(deleteStatusTickectAPI(id));
    setTimeout(() => {
      dispatch(listStatusTickectAPI());
    }, 500);
  };
...
export default listTicketStatus;
