...
// import AddTickets from "../../tickets/modalAddTicket";
// const tickets = () => {
...
//               <DrawerEditCustomer id={tableMeta.rowData[0]} />
//               <Button
//                 variant="outlined"
//                 color="error"
...
//         <div className="">Yêu cầu hổ trợ</div>
//         <div className="">
//           <AddTickets />
//           {/* <Button startIcon={<Add />} className="" onClick={()=>handleAll} variant="outlined">
//             yêu cầu
//           </Button> */}
//         </div>
//       </div>
...
import {
  deleteTickectAPI,
  getTicketByCustomerAPI,
  getAllTicketByCustomer,
} from "../../../features/ticketSlice";
import ModataEditTicket from "../../tickets/modalEditTicket";
...
const ListTicket = (props) => {
  ...
  const listTicket = useSelector(getAllTicketByCustomer);
  const handleDelete = (id) => {
    dispatch(deleteTickectAPI(id));
    setTimeout(() => {
      dispatch(getTicketByCustomerAPI(props?.id));
    }, 500);
  };
  useEffect(() => {
    dispatch(getTicketByCustomerAPI(props?.id));
      ...
      <div className="h-16 w-full bg-white rounded-2xl grid grid-cols-5 p-2 mb-2 px-4 shadow items-center">
        ...
        >
          <div className="flex flex-col justify-start items-start">
            ...
            <div className="text-[#4fc2c5] text-[14px]">Tổng số phiếu ghi</div>
          </div>
        </div>
        <div //
          className="col-span-1"
        >
          <div className="flex flex-col justify-start items-start">
            ...
            <div className="text-green-600 text-[14px]">Phiếu ghi mới tạo</div>
          </div>
        </div>
        <div //
        ...
        >
          <div className="flex flex-col justify-start items-start">
            ...
            <div className="text-red-500 text-[14px]">Phiếu ghi đang xử lý</div>
          </div>
        </div>
        <div //
          className="col-span-1"
        ...
        >
          <div className="flex flex-col justify-start items-start">
            ...
            <div className=" text-orange-500 text-[14px]">Phiếu ghi đã hủy</div>
          </div>
        </div>
        <div //
          className="col-span-1"
      ...
      <div className="h-auto w-full bg-white rounded-2xl p-3 shadow">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <ModalAddTicket customer_id={props?.id} />
          </div>
